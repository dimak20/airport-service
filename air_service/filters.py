...
class RouteFilter(django_filters.FilterSet):
    distance_min = django_filters.NumberFilter(
...
class FlightFilter(django_filters.FilterSet):
    ...
    departure_time_hour = django_filters.DateTimeFilter(
        method='filter_by_hour'
    )
...
class AirplaneFilter(django_filters.FilterSet):
    ...
    rows_min = django_filters.NumberFilter(
        field_name="rows", lookup_expr="gte"
    )
    rows_max = django_filters.NumberFilter(
        field_name="rows", lookup_expr="lte"
    )
